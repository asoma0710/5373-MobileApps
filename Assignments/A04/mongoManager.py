...
class MongoManager:
    ...
    def get_by_price_name_desc(self, min_price=None, max_price=None, name=None, description=None):
        """
        Retrieves documents from the collection based on the provided criteria.

        :param min_price: Minimum price of the candy.
        :param max_price: Maximum price of the candy.
